        ...
        <>
            <MorphingDialog>
                <MorphingDialogTrigger className="w-full">
                    <article onClickCapture={() => { defaultEditingRef.current = true; }} className="relative flex flex-col gap-3 rounded-3xl border border-border bg-card text-card-foreground p-4 custom-shadow transition-all duration-300 hover:scale-[1.02]">
                        ...
                        <dl className="relative grid grid-cols-2 gap-2">
                            <div className="flex items-center justify-between rounded-2xl border border-border/70 bg-background/80 px-2.5 py-2">
                                <dt className="sr-only">{t('requestCount')}</dt>
                                <span
                            ...
                            <div className="flex items-center justify-between rounded-2xl border border-border/70 bg-background/80 px-2.5 py-2">
                                <dt className="sr-only">{t('totalCost')}</dt>
                                <span
                                    className="flex h-8 w-8 items-center justify-center rounded-md bg-primary/10 text-primary"
                                    aria-hidden="true"
                                >
